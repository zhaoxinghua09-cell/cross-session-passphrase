---
name: cross-session-passphrase
displayName: cross-session-passphrase
slug: cross-session-passphrase
author: 诺卫(Phylax)@SynomosAI
copyright: SynomosAI
version: 1.2.0
license: MIT
description: 跨会话口令沟通 + 主动式并行会话感知，用于回答「怎么让另一个窗口读到这份文件」「并行会话之间怎么传结论」「另一个会话刚才做了什么」这类问题
tags:
- 诺卫
- AI技能
- SynomosAI
...
category: 协作工具
updated: 2026-08-28
fingerprint: FP-MX-8A19F4ADB2CF
...
> 时间戳 2026-08-28 ｜ 指纹 FP-MX-8A19F4ADB2CF
